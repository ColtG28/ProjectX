...
use parser_fixtures::{
    ...
    build_test_elf, build_test_elf_with_symbols, build_test_pe, build_test_pe_with_imports,
    malformed_elf_bad_bounds, malformed_elf_bad_symbol_table, malformed_pe_bad_lfanew,
